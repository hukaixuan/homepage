        ...
        <div v-for="item in list">
            <div class="detail-header">
                ...
                <div class="time">
                    ...
                    <span class="tag">{{item.label_name}}</span>
                </div>
            </div>
                <a :href="item.origin_url">原链接</a>
            ...
            <div class="detail-footer" v-comment>
                <Comment :ArticlesId="item.id"></Comment>
...
export default {
    ...
    methods: {
        fetchData (){
            ...
            this.$http.get('http://127.0.0.1:5000/api/v1/posts/'+id).then(
                res => {
                    this.list = []
